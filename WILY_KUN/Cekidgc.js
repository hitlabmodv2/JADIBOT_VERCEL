    ...
    const content = {
        ...
        contextInfo: {
            ...
            externalAdReply: {
                ...
                title: `📋 ${senderName}`,
                body: `Cek ID Grup • ${formattedDate}`,
                previewType: "IMAGE",
...
┃ ⌬ 4. Coba lagi dengan link yang fresh
┃ 
┃ 👤 *Status Anda*
┃ ⌬ Nomor: ${senderNumber}
...
_❌ Pastikan URL grup valid dan bot memiliki akses!_`;
                        ...
                        await ReplyRynzz(invalidUrlMessage, m, client);
                        return;
                    }
                } else {
...
_❌ Parameter harus berupa URL WhatsApp Group!_`;
                ...
                await ReplyRynzz(noUrlMessage, m, client);
                return;
            }
        } else {
