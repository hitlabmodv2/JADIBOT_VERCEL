    ...
    const content = {
        ...
        contextInfo: {
            ...
            externalAdReply: {
                ...
                title: `🎵 ${senderName}`,
                body: `YouTube Player • ${formattedDate}`,
                previewType: "IMAGE",
...
_🎵 Sedang mencari lagu terbaik untuk Anda..._`;
        ...
        try {
            ...
            if (!response.data || !response.data.status) {
                await ReplyRynzz("❌ Gagal mencari lagu. API tidak merespons dengan benar!", m, client);
                return;
            }
            ...
            if (!data || !data.metadata || !data.downloadUrl) {
                await ReplyRynzz("❌ Lagu tidak ditemukan atau format response tidak valid!", m, client);
                return;
            }
...
_🎶 Audio sedang diproses, mohon tunggu..._`;
            ...
            if (!audioResponse.data) {
                await ReplyRynzz("❌ Gagal mengunduh audio dari server!", m, client);
                return;
            }
            ...
            if (audioBuffer.length === 0) {
                await ReplyRynzz("❌ File audio kosong atau corrupt!", m, client);
                return;
            }
...
_🎶 Selamat menikmati musik pilihan Anda!_`,
            ...
            if (apiError.code === 'ECONNABORTED') {
                ...
                await ReplyRynzz("❌ Lagu tidak ditemukan! Coba gunakan kata kunci yang berbeda.", m, client);
