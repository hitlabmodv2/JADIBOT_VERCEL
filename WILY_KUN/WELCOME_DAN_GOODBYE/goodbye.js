...
> ✨ Semoga sukses dan bahagia selalu!`;
    ...
    // Struktur pesan dengan 2 media (anime + PP user)
    const messageContent = {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterName: "SELAMAT TINGGAL 👋",
          newsletterJid: "120363312297133690@newsletter",
        },
        externalAdReply: {
          showAdAttribution: true,
          title: `${removeType === 'remove' ? '👢 Member Dikick!' : '🚪 Member Keluar!'}`,
          body: `${groupName} • ${jakartaDate}`,
          previewType: "VIDEO",
          thumbnailUrl: ppUser,
        ...
        quotedMessage: animeMedia ? {
          videoMessage: {
            url: animeMediaPath,
            mimetype: 'video/mp4',
            caption: `🎭 Goodbye Animation • ${userName}`
          }
        } : {
          imageMessage: {
            url: ppUser,
            mimetype: 'image/jpeg',
            caption: `👤 Profile Picture • ${userName}`
          }
        }
      }
    };
